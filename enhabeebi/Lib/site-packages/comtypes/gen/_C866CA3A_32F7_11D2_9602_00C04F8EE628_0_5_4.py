...
__all__ = [
    'SVF_Emphasis', 'DISPID_SRCRetainedAudioFormat', 'SPPS_Modifier',
    ...
    'DISPID_SpeechCustomStream', 'ISpEventSink', 'eLEXTYPE_PRIVATE16',
    'SPSModifier', 'ISpeechWaveFormatEx',
    'ISpeechObjectTokenCategory', '_ISpeechVoiceEvents',
    'SGRSTTEpsilon', 'SDTRule', 'SVSFPersistXML', 'DISPID_SPCLangId',
    'SVSFIsNotXML', 'SINoSignal', 'SP_VISEME_1',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRDisplayAttributes', 'ISpeechRecoResultDispatch',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPANumberOfElementsInResult', 'SECFIgnoreKanaType',
    'SpeechAudioFormatGUIDText', 'DISPID_SGRSTransitions',
    'SP_VISEME_0', 'SpeechRecognitionType', 'SREBookmark',
    'DISPID_SVSpeakStream', 'ISpRecoCategory', 'SPINTERFERENCE_NONE',
    'SAFT48kHz16BitStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'SVP_19', 'SpPhoneConverter', 'SpLexicon', 'SVSFIsXML',
    'ISpRecoGrammar', 'DISPID_SPRs_NewEnum',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_PRIVATE18',
    'ISpObjectWithToken', 'DISPID_SRGCmdLoadFromObject',
    'SAFTDefault', 'SVEBookmark', 'SVPOver', 'DISPID_SRRTTickCount',
    ...
    'DISPID_SVSLastBookmarkId', 'STSF_AppData', 'ISpRecoResult',
    'ISpXMLRecoResult', 'ISpStreamFormatConverter',
    'DISPID_SRRPhraseInfo', 'ISpNotifySink',
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechGrammarRuleStateTransitionType', 'SPGS_DISABLED',
    ...
    'DISPID_SRGCmdLoadFromFile', 'SPFM_NUM_MODES', 'SVP_2',
    'DISPID_SDKEnumKeys', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechLexicon', 'DISPID_SVRate',
    'DISPID_SASFreeBufferSpace', 'ISpeechPhraseReplacements',
    'SDTReplacement',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechGrammarRules', 'DISPID_SRCreateRecoContext',
    'ISpeechLexicon', 'DISPID_SVAlertBoundary', 'SDTAlternates',
    'SPDKL_DefaultLocation', 'SECNormalConfidence',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_PRIVATE3',
    'DISPID_SDKGetlongValue', 'DISPID_SDKDeleteKey', 'DISPID_SGRName',
    'DISPID_SRCRecognizer', 'SAFT32kHz16BitMono',
    'SpInProcRecoContext', 'DISPID_SRGetFormat',
    'DISPID_SPEActualConfidence', 'SpPhoneticAlphabetConverter',
    'ISpStreamFormat', 'DISPID_SVGetProfiles',
    'SPEI_RECO_STATE_CHANGE', 'SpSharedRecognizer', 'SVP_7', 'SVP_18',
    'SDA_No_Trailing_Space', 'SECHighConfidence',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRGRecoContext', 'SITooQuiet',
    'SP_VISEME_7', 'SRCS_Disabled', 'SpMMAudioIn',
    'DISPID_SRRecognizer', 'SDKLLocalMachine', 'SPGRAMMARWORDTYPE',
    'SAFTNonStandardFormat', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechCategoryRecognizers', 'ISpProperties',
    'DISPID_SPERetainedSizeBytes', 'SITooFast', 'SPEI_HYPOTHESIS',
    ...
    'DISPID_SWFEBlockAlign', 'SAFT32kHz8BitStereo',
    'SWPUnknownWordUnpronounceable', 'SBOPause', 'ISpeechRecoResult2',
    ...
    'SpeechAudioState', 'DISPID_SPPEngineConfidence',
    'SVSFNLPSpeakPunc', 'SPSMF_UPS', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVSLastResult', 'eLEXTYPE_PRIVATE15', 'DISPIDSPRG',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRSTsCount', 'SPEI_TTS_PRIVATE',
    'SpeechGrammarTagDictation', 'SVP_14', 'DISPID_SABIEventBias',
    ...
    'DISPID_SGRsCount', 'SPDKL_CurrentConfig', 'ISequentialStream',
    'SVSFParseMask', 'DISPID_SAFType',
    'DISPID_SASCurrentSeekPosition', 'ISpRecognizer', 'SGDSActive',
    'ISpVoice', 'SAFTTrueSpeech_8kHz1BitMono', 'SAFT22kHz16BitStereo',
    'eLEXTYPE_PRIVATE14', 'SPEI_WORD_BOUNDARY', 'SPFM_CREATE_ALWAYS',
    'DISPID_SGRSTRule', 'SGLexicalNoSpecialChars',
    'DISPID_SRCBookmark', 'SPXRO_Alternates_SML', 'SAFT32kHz8BitMono',
    'DISPID_SRState', 'STSF_CommonAppData', 'SPAR_Medium', 'SBONone',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRuleChildren',
    'SLOStatic', 'ISpeechDataKey', 'SpCustomStream', 'SGRSTTRule',
    'DISPID_SPEsCount', 'SpeechVoiceSpeakFlags', 'SRTExtendableParse',
    'tagSTATSTG', 'SpeechVoiceSkipTypeSentence', 'SPCT_SLEEP',
    'SP_VISEME_12', 'SPEI_RESERVED5', 'SPVPRI_NORMAL',
    'DISPID_SpeechPhraseElement', 'DISPID_SPPConfidence',
    'DISPID_SPRuleName', 'SPINTERFERENCE_TOOSLOW', 'SPEI_RESERVED2',
    'DISPID_SRCESoundEnd', 'SPEI_SR_AUDIO_LEVEL', 'SDTAll',
    'DISPID_SDKDeleteValue', 'DISPID_SVSCurrentStreamNumber',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPEAudioSizeBytes', 'STSF_FlagCreate',
    'DISPID_SWFEChannels', 'SGRSTTWildcard', 'DISPID_SVPause',
    'SVESentenceBoundary', 'DISPID_SLWWord', 'SPVPRIORITY',
    'SpeechPropertyResponseSpeed', 'SRESoundEnd', 'DISPID_SRRTimes',
    'SAFT8kHz8BitMono', 'DISPID_SpeechGrammarRuleState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechBookmarkOptions',
    'DISPID_SRRDiscardResultInfo', 'SASStop', 'SPPHRASE',
    'SVEStartInputStream', 'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechResourceLoader', 'SPRS_ACTIVE_USER_DELIMITED',
    'eLEXTYPE_PRIVATE19', 'SPSHT_OTHER', 'SpeechCategoryAudioIn',
    'SAFT22kHz16BitMono', 'SAFTADPCM_11kHzStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT12kHz16BitStereo', 'SP_VISEME_3', 'ISpeechRecognizer',
    'SpeechAudioProperties', 'DISPID_SRGDictationUnload',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRId', 'SPWT_PRONUNCIATION',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SBSRead',
    'ISpeechLexiconWords', 'DISPID_SPRulesCount',
    ...
    'SPEI_START_SR_STREAM', 'SPPARTOFSPEECH', 'SPSHORTCUTTYPE',
    'SPRST_ACTIVE', 'DISPID_SRGIsPronounceable',
    'DISPIDSPTSI_ActiveLength', 'SREStreamEnd', 'SRERecognition',
    'SREPropertyNumChange', 'SP_VISEME_14', 'SpeechGrammarWordType',
    'SPRULESTATE', 'eLEXTYPE_RESERVED7',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCState',
    'ISpeechAudioStatus', 'SVEAllEvents', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_USER', 'SVSFIsFilename', 'ISpLexicon', 'SVP_6',
    'DISPID_SVGetAudioInputs', 'SPEVENT', 'SPPS_NotOverriden',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechXMLRecoResult',
    'ISpeechRecoResult', 'SECFEmulateResult', 'ISpPhrase',
    'ISpeechMemoryStream', 'DISPID_SRCEAudioLevel', 'SVP_11',
    'SpSharedRecoContext', 'SSTTTextBuffer', 'SPGS_ENABLED',
    'SP_VISEME_17', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SGRAddState', 'SVP_15', 'IEnumSpObjectTokens',
    'DISPID_SVIsUISupported', 'DISPID_SLWPronunciations',
    'DISPID_SVVolume', 'SPPS_Noun', 'eLEXTYPE_PRIVATE1',
    'SpeechTokenValueCLSID', 'DISPID_SpeechRecoResultTimes',
    'SAFTGSM610_11kHzMono', 'WAVEFORMATEX', 'SPPS_Function',
    'DISPID_SpeechRecoResult', 'SAFTText', 'DISPID_SLPsItem',
    'DISPID_SRCEPropertyStringChange', 'SPRST_ACTIVE_ALWAYS',
    'SPEI_ADAPTATION', 'DISPID_SGRsFindRule', 'SREFalseRecognition',
    'SSTTWildcard', 'DISPID_SPCPhoneToId', 'SPRECORESULTTIMES',
    ...
    'SGDSActiveWithAutoPause', 'SPRULE', 'SAFT8kHz16BitMono',
    'eLEXTYPE_PRIVATE5', 'SPAS_RUN', 'SECLowConfidence',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCERequestUI',
    'ISpeechPhoneConverter', 'SVPAlert', 'SPPS_RESERVED2',
    'ISpeechRecognizerStatus', 'SAFTCCITT_ALaw_22kHzStereo',
    'SREAudioLevel', 'SpObjectToken',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpStream',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPPChildren',
    'DISPID_SPIEngineId', 'ISpeechAudioFormat',
    'SDA_Consume_Leading_Spaces', 'SPINTERFERENCE_TOOFAST',
    'SP_VISEME_11', 'DISPID_SVEStreamEnd',
    '_ISpeechRecoContextEvents',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SRSActiveAlways',
    'SP_VISEME_21', 'SAFT22kHz8BitStereo', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRSetPropertyNumber', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVP_13', 'DISPID_SpeechRecognizer',
    'SPPS_Noncontent', 'SpeechDataKeyLocation',
    'SPINTERFERENCE_NOISE', 'SPDKL_CurrentUser',
    'DISPID_SVEStreamStart', 'SPBO_NONE', 'DISPID_SVSpeak',
    'SRERecoOtherContext', 'SPEI_MIN_TTS', 'SPSEMANTICERRORINFO',
    ...
    'DISPID_SPPParent', 'DISPID_SPAPhraseInfo', 'SP_VISEME_4',
    'SpStreamFormatConverter', 'eLEXTYPE_PRIVATE20', 'SREAllEvents',
    'SPWF_INPUT', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SASRun',
    'SpShortcut', 'DISPID_SVSInputSentenceLength', 'STCInprocHandler',
    'SRSInactiveWithPurge', 'DISPID_SRAudioInput',
    'DISPID_SGRsCommit', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPAsCount', 'DISPID_SGRSTs_NewEnum', 'SPAS_CLOSED',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPISaveToMemory',
    'SPINTERFERENCE', 'SRSEDone', 'DISPID_SVSRunningState',
    'SPVISEMES', 'SpeechVoiceEvents', 'SVP_20', 'SVSFParseSapi',
    'SVSFParseAutodetect', 'SPSERIALIZEDPHRASE', 'SPLEXICONTYPE',
    'ISpeechPhraseProperty', 'ISpRecoGrammar2',
    'DISPID_SRGetPropertyString', 'DISPID_SpeechBaseStream',
    'IInternetSecurityMgrSite', 'DISPID_SVEViseme', 'SGSDisabled',
    'SREPropertyStringChange', 'DISPID_SpeechVoice',
    'DISPID_SLWLangId', 'DISPID_SRCEAdaptation', 'SPWT_LEXICAL',
    'DISPID_SOTCSetId', 'SDTDisplayText', 'ISpeechBaseStream',
    'SpCompressedLexicon', 'SPPHRASEELEMENT',
    'DISPID_SDKSetBinaryValue', 'SPSTREAMFORMATTYPE', 'SITooSlow',
    'SECFIgnoreWidth', 'DISPID_SpeechAudio', 'SpeechPartOfSpeech',
    'DISPID_SGRInitialState', 'SREStreamStart', 'DISPID_SRDisplayUI',
    'SECFIgnoreCase', 'SPEI_SR_PRIVATE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpFileStream',
    'DISPID_SGRSTPropertyId', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVDisplayUI', 'DISPID_SRCVoice', 'DISPID_SVAudioOutput',
    'DISPID_SRRRecoContext', 'DISPID_SVAudioOutputStream',
    'ISpeechLexiconWord', 'ISpeechAudio', 'DISPID_SRRSpeakAudio',
    'DISPID_SGRsItem', 'SPINTERFERENCE_TOOQUIET', 'STSF_LocalAppData',
    'SPEI_MAX_SR', 'SpeechSpecialTransitionType',
    'DISPID_SpeechObjectToken', 'DISPID_SADefaultFormat', 'SDTAudio',
    'SREAdaptation', 'SAFTCCITT_uLaw_22kHzMono', 'SAFT11kHz8BitMono',
    'SPVPRI_OVER', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SDKGetStringValue', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRRTLength', 'eLEXTYPE_MORPHOLOGY', 'SPAR_High',
    'SDA_One_Trailing_Space', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechTokenKeyUI', 'SpNullPhoneConverter', 'SpPhraseInfoBuilder',
    'DISPID_SpeechRecoResult2', 'DISPID_SRRAudioFormat',
    'SPEI_VISEME', 'SPAS_PAUSE', 'eLEXTYPE_RESERVED6',
    'DISPID_SLWType', 'SpeechVisemeType', 'SVSFParseSsml',
    'SVSFlagsAsync', 'SpeechWordPronounceable', 'SRAImport',
    'DISPID_SPARecoResult', 'DISPID_SOTIsUISupported',
    'DISPID_SRCResume', 'SpeechLexiconType',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SAFGuid',
    'SRESoundStart', 'SPRST_INACTIVE', 'SDTLexicalForm',
    'SP_VISEME_15', 'SAFT8kHz16BitStereo', 'DISPID_SLPsCount',
    'ISpeechFileStream', 'eWORDTYPE_DELETED', 'ISpRecognizer3',
    'SAFTCCITT_uLaw_44kHzMono', 'SPCS_ENABLED', 'STCAll',
    'SPWAVEFORMATTYPE', 'DISPID_SPEDisplayText', 'SPEI_TTS_BOOKMARK',
    'SGRSTTDictation', 'DISPID_SOTDataKey',
    'DISPID_SOTGetDescription', 'DISPID_SOTRemove',
    'SAFT24kHz16BitMono', 'SWPKnownWordPronounceable',
    'SPSNotOverriden', 'SPPS_LMA', 'SAFT48kHz16BitMono',
    'SpTextSelectionInformation', 'DISPID_SpeechLexiconWords',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SFSClose',
    'DISPID_SLWsItem', 'SRERequestUI', 'DISPID_SRProfile', 'SPSVerb',
    'SPWORD', 'SpeechRuleState', 'DISPID_SRGDictationSetState',
    'SAFT24kHz16BitStereo', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE11',
    'SRADefaultToActive', 'DISPID_SPRuleId', 'DISPID_SGRsDynamic',
    'ISpeechTextSelectionInformation', 'SPEI_PHRASE_START',
    'DISPID_SWFEFormatTag', 'SP_VISEME_18', 'SFTSREngine',
    'SpeechCategoryVoices', 'SpeechTokenKeyAttributes', 'SPXRO_SML',
    'SPAUDIOBUFFERINFO', 'SVP_0', 'DISPID_SPEsItem',
    'DISPID_SLPLangId', 'SRTReSent', 'SpeechFormatType',
    'DISPID_SGRSTText', '_RemotableHandle', 'ISpeechPhraseInfo',
    'SVP_10', 'DISPID_SPEAudioSizeTime', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRGId', 'ISpeechCustomStream', 'ISpRecoContext2',
    'DISPID_SVESentenceBoundary', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTId', 'DISPID_SASState',
    'ISpeechPhraseProperties', 'SPEI_RESERVED1', 'DISPID_SLWsCount',
    'SPWF_SRENGINE', 'DISPID_SGRSRule', 'SPRST_INACTIVE_WITH_PURGE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpNotifyTranslator',
    'SAFTGSM610_8kHzMono', 'SRADynamic',
    'ISpeechGrammarRuleStateTransition', 'SAFT48kHz8BitMono',
    'DISPID_SVSInputSentencePosition', 'SPWT_DISPLAY', 'UINT_PTR',
    'ISpPhraseAlt', 'SPSInterjection', 'DISPID_SOTs_NewEnum',
    'SP_VISEME_6', 'ISpeechPhraseRules', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechVoiceStatus', 'SAFTADPCM_22kHzMono',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVEAudioLevel', 'SRSInactive',
    'IStream', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGSetWordSequenceData',
    'ISpeechMMSysAudio', 'SPEI_RESERVED6', 'SP_VISEME_16',
    'DISPID_SpeechObjectTokens', 'DISPID_SLAddPronunciation',
    'SAFT32kHz16BitStereo', 'ISpeechPhraseAlternate',
    'DISPID_SVGetVoices', 'SVEPrivate', 'SPEI_PROPERTY_NUM_CHANGE',
    'SP_VISEME_9', 'SPSFunction', 'SSFMOpenReadWrite',
    'SAFT11kHz16BitMono', 'SRCS_Enabled', 'SVSFVoiceMask',
    'SAFT44kHz8BitMono', 'DISPID_SRCESoundStart', 'DISPID_SPAsItem',
    'DISPID_SVVoice', 'SVEViseme', 'SPBO_TIME_UNITS',
    'SAFT44kHz8BitStereo', 'DISPID_SRIsUISupported', 'SRTEmulated',
    'DISPID_SBSWrite', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SASNonBlockingIO', 'DISPID_SVEventInterests',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRsCount', 'SpeechWordType',
    'DISPID_SpeechPhraseAlternates', 'SpeechTokenContext', 'SPSNoun',
    'DISPID_SLPSymbolic', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_PRIVATE4', 'SPSHORTCUTPAIR', 'ISpResourceManager',
    'DISPID_SPILanguageId', 'SP_VISEME_19',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SBSSeek', 'DISPID_SRGState', 'SPWORDPRONOUNCEABLE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRAInterpreter',
    'ISpRecoContext', 'DISPID_SGRClear', 'SVSFNLPMask',
    ...
    'eWORDTYPE_ADDED', 'DISPID_SVEBookmark',
    'SpeechGrammarTagWildcard', 'DISPID_SMSADeviceId',
    'DISPID_SVSInputWordLength', 'SpObjectTokenCategory',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPRuleFirstElement',
    'SPCT_COMMAND', 'DISPID_SRCERecognizerStateChange', 'SPSLMA',
    'ISpeechPhraseInfoBuilder', 'SVEVoiceChange',
    'DISPID_SRRSaveToMemory', 'SPEI_UNDEFINED',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTDisplayUI',
    'DISPID_SMSALineId', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPRules_NewEnum', 'SPLOADOPTIONS',
    'DISPID_SGRsCommitAndSave', 'SPAR_Low', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SVSkip', 'DISPID_SRRGetXMLResult', 'SPRS_ACTIVE',
    'SpeechCategoryAudioOut', 'DISPID_SpeechPhraseProperty',
    'SPBO_AHEAD', 'ISpeechPhraseRule', 'SWTDeleted',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCVoicePurgeEvent',
    'SVP_3', 'DISPID_SRCEInterference', 'DISPID_SpeechRecoContext',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SASetState', 'SSTTDictation',
    'DISPID_SABufferNotifySize', 'SAFT12kHz8BitStereo',
    'DISPID_SRCPause', 'eLEXTYPE_APP', 'ISpeechPhraseAlternates',
    'ISpStream', 'ISpRecognizer2', 'SpeechStreamSeekPositionType',
    'ISpeechObjectTokens', 'SPCT_SUB_DICTATION', 'SAFT24kHz8BitMono',
    'SpeechMicTraining', 'SRAONone', 'DISPID_SPEEngineConfidence',
    'DISPID_SOTGetAttribute', 'SGSEnabled', 'eLEXTYPE_RESERVED8',
    'ISpGrammarBuilder', 'SPEI_SENTENCE_BOUNDARY', 'SECFDefault',
    'SpeechAudioVolume', 'DISPID_SPAs_NewEnum', 'SPPS_RESERVED4',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechDataKey', 'DISPID_SPPsCount',
    'DISPID_SRRTStreamTime', 'DISPID_SDKCreateKey',
    'DISPID_SRCRetainedAudio', 'SVEEndInputStream', 'SPEI_MAX_TTS',
    'ISpeechRecoResultTimes', 'SPEI_SOUND_START',
    'DISPID_SGRAddResource', 'SpeechCategoryPhoneConverters',
    'SSSPTRelativeToStart', 'ISpeechPhraseElement',
    'SPEI_SR_BOOKMARK', 'SP_VISEME_2', 'DISPID_SPEAudioTimeOffset',
    'SRTAutopause', 'DISPID_SGRSTPropertyName', 'SREHypothesis',
    'DISPID_SPPName', 'SPDATAKEYLOCATION', 'SPAUDIOSTATE',
    'STCRemoteServer', 'SREInterference', 'DISPID_SPIAudioSizeTime',
    'SSSPTRelativeToEnd', 'SDTProperty', 'SRTSMLTimeout',
    'SpMMAudioOut', 'SREPrivate', 'SDKLCurrentConfig',
    'DISPID_SBSFormat', 'SAFTADPCM_22kHzStereo', 'SpeechGrammarState',
    'eLEXTYPE_RESERVED9', 'DISPID_SGRSTNextState',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SWFEExtraData',
    ...
    'DISPID_SLPPhoneIds', 'DISPID_SRGSetTextSelection', 'SRARoot',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSTWeight', 'SVP_4',
    'DISPID_SOTsCount', 'DISPID_SVEPhoneme', 'ISpeechAudioBufferInfo',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRFirstElement',
    'Speech_Max_Pron_Length', 'SPFM_OPEN_READONLY',
    'SGRSTTTextBuffer', 'DISPID_SVEEnginePrivate',
    'eLEXTYPE_PRIVATE12', 'SRATopLevel', 'DISPID_SOTsItem',
    'DISPID_SDKSetLongValue', 'DISPID_SVGetAudioOutputs',
    'SP_VISEME_5', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVResume', 'SSFMCreate',
    'SpInprocRecognizer', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SLGetWords', 'SRTStandard', 'DISPID_SOTSetId',
    'SPSHT_Unknown', 'SpWaveFormatEx', 'DISPID_SPIReplacements',
    'SPEI_SOUND_END', 'SINoise', 'SPCATEGORYTYPE', 'ISpDataKey',
    'ISpeechPhraseReplacement', 'tagSPTEXTSELECTIONINFO',
    'ISpNotifySource', 'SAFT16kHz16BitStereo', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLWs_NewEnum', 'DISPID_SPACommit', 'DISPID_SPRulesItem',
    'SVP_5', 'DISPID_SAVolume', 'SPEI_REQUEST_UI', 'SPEI_RESERVED3',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPPFirstElement',
    'SGDSActiveUserDelimited', 'SITooLoud', 'DISPID_SRIsShared',
    'ISpMMSysAudio', 'DISPID_SAStatus', 'SGRSTTWord',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPNumberOfElements', 'DISPID_SMSAMMHandle',
    'SREStateChange', 'DISPID_SPIElements', 'SASClosed',
    'DISPID_SRCEBookmark', 'SPVPRI_ALERT', 'DISPID_SOTCreateInstance',
    'SPPHRASEREPLACEMENT', 'SpeechTokenShellFolder',
    'SRAORetainAudio', 'ISpeechRecoContext', 'eLEXTYPE_RESERVED4',
    'IEnumString', 'Speech_StreamPos_RealTime',
    'DISPID_SRAudioInputStream', 'Speech_StreamPos_Asap',
    'DISPID_SPIRule', 'SPTEXTSELECTIONINFO', 'SAFT16kHz16BitMono',
    'SPPS_Unknown', 'DISPID_SRGCmdLoadFromResource',
    'SpeechInterference', 'SAFT16kHz8BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRCSetAdaptationData',
    'eLEXTYPE_PRIVATE2', 'SPAUDIOSTATUS', 'SpeechRecognizerState',
    ...
    'DISPID_SOTMatchesAttributes', 'SPGRAMMARSTATE',
    'SPSEMANTICFORMAT', 'DISPID_SGRSTsItem', 'SRAExport',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechPhraseAlternate',
    'SVSFUnusedFlags', 'SAFTGSM610_44kHzMono',
    'DISPID_SABIMinNotification', 'SVPNormal', 'SAFT12kHz8BitMono',
    'SVEPhoneme', 'SPAS_STOP', 'DISPID_SpeechRecognizerStatus',
    'SpeechAudioFormatType', 'SP_VISEME_8',
    'DISPID_SpeechAudioFormat', 'SWPUnknownWordPronounceable',
    'SpeechEngineProperties', 'DISPID_SABIBufferSize',
    'SpeechPropertyAdaptationOn', 'DISPID_SRGDictationLoad',
    'SPEI_RECOGNITION', 'ISpeechGrammarRuleState',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechGrammarRules',
    '_SPAUDIOSTATE', 'DISPID_SPERetainedStreamOffset',
    'tagSPPROPERTYINFO', 'SAFT11kHz16BitStereo',
    'DISPID_SRSClsidEngine', 'SpeechUserTraining',
    'DISPID_SpeechPhraseReplacement', 'SPAO_NONE', 'SDTPronunciation',
    'DISPID_SGRSAddRuleTransition', 'ISpeechLexiconPronunciation',
    'SFTInput', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPEVENTENUM',
    'DISPID_SPPsItem', 'DISPID_SGRSTType', 'DISPID_SRGRules',
    'DISPID_SPIStartTime', 'DISPID_SRStatus',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWORDTYPE',
    'SRSEIsSpeaking', 'SPWORDLIST', 'DISPID_SpeechLexiconWord',
    'SAFTADPCM_44kHzStereo', 'SVF_Stressed', 'ISpeechRecoGrammar',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCEStartStream',
    'SpeechTokenIdUserLexicon', 'SVP_9', 'Speech_Max_Word_Length',
    'DISPID_SGRsAdd', 'SREPhraseStart', 'SVP_8', 'SPPS_RESERVED1',
    'SPPS_RESERVED3', 'DISPID_SPEPronunciation', 'SPGS_EXCLUSIVE',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRSetPropertyString',
    'SpeechRegistryLocalMachineRoot', 'SGDisplay',
    'DISPID_SpeechObjectTokenCategory', 'SAFT22kHz8BitMono', 'SVP_17',
    'SPPS_Interjection', 'DISPID_SVSLastBookmark', 'SPCONTEXTSTATE',
    'DISPID_SOTCId', 'ISpPhoneticAlphabetSelection',
    'STCInprocServer', 'DISPID_SREmulateRecognition',
    'DISPID_SVEWord', 'SAFTGSM610_22kHzMono', 'SPEI_END_SR_STREAM',
    'ISpSerializeState', 'DISPIDSPTSI', 'Speech_Default_Weight',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechObjectToken', 'DISPID_SMSSetData', 'SPEI_INTERFERENCE',
    'DISPID_SRGReset', 'DISPID_SAEventHandle', 'DISPID_SLPType',
    'SpeechVoicePriority', 'ISpAudio', 'DISPID_SLPs_NewEnum',
    'SPRST_NUM_STATES', 'SPSSuppressWord', 'SINone',
    'DISPID_SRCEEndStream', 'SVP_16',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_PRIVATE10', 'SpeechLoadOption', 'DISPID_SVStatus',
    'SDKLCurrentUser', 'DISPID_SPEDisplayAttributes', 'LONG_PTR',
    'SPEVENTSOURCEINFO', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTCGetDataKey', 'DISPID_SASCurrentDevicePosition',
    'SPFILEMODE', 'SpVoice', 'DISPID_SPPValue', 'SRSActive',
    'DISPID_SPELexicalForm', 'SPAUDIOOPTIONS', 'SPAR_Unknown',
    'SPWORDPRONUNCIATION', 'ISpeechVoice', 'SAFT48kHz8BitStereo',
    'SASPause', 'SPEI_START_INPUT_STREAM', 'DISPID_SPRuleParent',
    'DISPID_SCSBaseStream', 'DISPID_SVPriority',
    'SAFT24kHz8BitStereo', 'ISpObjectTokenCategory', 'SVEAudioLevel',
    'ISpeechVoiceStatus', 'SpeechDisplayAttributes', 'SVP_1',
    'DISPID_SGRSAddWordTransition', 'SGPronounciation',
    'DISPIDSPTSI_SelectionLength', 'SPRS_INACTIVE',
    'DISPID_SLGenerationId', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPIGetText', 'SpeechAddRemoveWord',
    'SAFT44kHz16BitStereo', 'SVSFDefault',
    'SpeechCategoryRecoProfiles', 'SPPHRASERULE',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRCEventInterests',
    'SWTAdded', 'SAFT16kHz8BitMono', 'SpeechEngineConfidence',
    'SPSUnknown', 'DISPID_SGRAttributes', 'SPRECOGNIZERSTATUS',
    'SpeechRegistryUserRoot', 'DISPID_SRRAudio',
    'SAFT11kHz8BitStereo', 'DISPID_SPCIdToPhone', 'SSFMOpenForRead',
    'DISPID_SRGetRecognizers', 'SGDSInactive',
    'ISpPhoneticAlphabetConverter', 'SPSERIALIZEDRESULT',
    'DISPID_SFSOpen', 'eLEXTYPE_RESERVED10', 'SLODynamic',
    'SECFNoSpecialChars', 'SPPS_SuppressWord', 'DISPID_SPRsItem',
    'STCLocalServer', 'SGSExclusive', 'SPBINARYGRAMMAR',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE8',
    'ISpeechXMLRecoResult', 'SPCS_DISABLED', 'SLTUser',
    'DISPID_SVSPhonemeId', 'ISpEventSource', 'SpeechDiscardType',
    'DISPID_SpeechPhraseElements', 'DISPID_SRRAlternates',
    'DISPID_SOTCDefault', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPLO_DYNAMIC', 'DISPID_SLRemovePronunciation', 'ISpObjectToken',
    'SPDKL_LocalMachine', 'SpeechRecoEvents',
    'DISPID_SRRTOffsetFromStart', 'SpMMAudioEnum',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRText', 'DISPID_SABufferInfo',
    ...
    'SPCT_DICTATION', 'DISPID_SPRuleConfidence',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechAudioBufferInfo',
    'SVP_12', 'SAFTADPCM_8kHzMono', 'SAFT44kHz16BitMono',
    'SPVOICESTATUS', 'eLEXTYPE_PRIVATE17', 'SAFTADPCM_8kHzStereo',
    'SVF_None', 'ISpeechGrammarRule', 'ISpShortcut', 'SPEI_MIN_SR',
    'SpeechRecoContextState', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SpeechPhraseProperties', 'SPBO_PAUSE', 'SPPS_Verb',
    'SLTApp', 'eLEXTYPE_PRIVATE6', 'DISPID_SRCERecognition',
    'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_10',
    'SPSHT_NotOverriden', 'SpeechStreamFileMode',
    'DISPID_SRRGetXMLErrorInfo', 'SPFM_CREATE',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVSVisemeId', 'DISPID_SRGCommit',
    'SP_VISEME_13', 'SVP_21', 'SGLexical',
    'DISPID_SLGetPronunciations', 'SpeechRunState', 'SPPROPERTYINFO'
]

_check_version('1.2.0', 1697227114.891110)
